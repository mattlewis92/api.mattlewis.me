...
const tweetsAction = require('./actions/social/get-tweets');
const githubReposAction = require('./actions/social/github-repos');
const sendEmailAction = require('./actions/contact/send-email');
